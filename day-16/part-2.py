...
class Packet:
    ...
    def value(self):
        if self.type_id == 0:
            ...
            raise NotImplementedError("Unknown type ID.")
...
packet8 = Packet(hex_to_bytes("C200B40A82"))
assert packet8.value == 3

packet9 = Packet(hex_to_bytes("04005AC33890"))
assert packet9.value == 54

packet10 = Packet(hex_to_bytes("880086C3E88112"))
assert packet10.value == 7

packet11 = Packet(hex_to_bytes("CE00C43D881120"))
assert packet11.value == 9

packet12 = Packet(hex_to_bytes("D8005AC2A8F0"))
assert packet12.value == 1

packet13 = Packet(hex_to_bytes("F600BC2D8F"))
assert packet13.value == 0

packet14 = Packet(hex_to_bytes("9C005AC2F8F0"))
assert packet14.value == 0

packet15 = Packet(hex_to_bytes("9C0141080250320F1802104A08"))
assert packet15.value == 1
